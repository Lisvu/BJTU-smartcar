...
class OdomPublisher:public rclcpp ::Node
{
   ...
   double _x_of_car = 0.0;
   double _y_of_car = 0.0;
        ...
        tf_broadcaster_ = std::make_unique<tf2_ros::TransformBroadcaster>(*this);
	  	...
	  	private:
            ...
            //geometry_msgs::msg::Twist twist;
	  	  	...
	  	  	//linear_velocity_x_ = msg->linear.x * 1.45;// scale = 1
			//linear_velocity_x_ = msg->linear.x * 1.8 *1.2;// scale = 1
			//linear_velocity_x_ = msg->linear.x * 1.0;// scale = 1
			linear_velocity_x_ = msg->linear.x;// * msg->linear.x *1.7 + msg->linear.x*0.15;
    		//linear_velocity_y_ = msg->linear.y * linear_scale_y_;
    		//linear_velocity_y_ = msg->linear.y * 1.6 * 1.2;
           ...
           // std::cout<<"vel_dt: "<<vel_dt_<<std::endl;
			...
			// calculate the distance in terms of x and y of the car
			this->_x_of_car += linear_velocity_x_ * vel_dt_;
			this->_y_of_car += linear_velocity_y_ * vel_dt_;
